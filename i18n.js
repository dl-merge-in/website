...
(() => {
  ...
  const copy = {
    en: {
      ...
      changelogMetaDescription: "DL-Merge-In release history and update details.", changelogKicker: "Release history", changelogTitle: "Change history", changelogLead: "Details for versions delivered through DL-Merge-In updates.", changelog122Title: "Version 1.2.2", changelog122Date: "Published September 6, 2026", changelog122Summary: "Temporary public release for the update installation retest.", changelog122Body: "There are no functional changes. Only the version metadata and build identifier differ from the corrected test baseline version 1.2.0.", changelog121Title: "Version 1.2.1", changelog121Date: "Publication ended September 6, 2026", changelog121Summary: "Test-only version withdrawn after the first installation test was stopped.", changelog121Body: "The Release was deleted after a concurrent Chrome and Edge startup issue was found. This version will not be reused."
    },
    ja: {
      ...
      changelogMetaDescription: "DL-Merge-Inの公開バージョン履歴とアップデート内容です。", changelogKicker: "リリース履歴", changelogTitle: "変更履歴", changelogLead: "DL-Merge-Inのアップデートで配信する各バージョンの内容を掲載します。", changelog122Title: "バージョン 1.2.2", changelog122Date: "2026年9月6日公開", changelog122Summary: "アップデート機能の実機再試験用に一時公開するバージョンです。", changelog122Body: "機能上の変更はありません。同時起動修正版のバージョン1.2.0から、バージョン情報とビルド識別子だけを変更しています。", changelog121Title: "バージョン 1.2.1", changelog121Date: "2026年9月6日公開終了", changelog121Summary: "第1回実機試験を中止し、公開を終了したテスト専用バージョンです。", changelog121Body: "ChromeとEdgeの同時起動問題を検出したため、Releaseを削除しました。このバージョンは再利用しません。"
    },
