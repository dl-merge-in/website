...
(() => {
  ...
  const copy = {
    en: {
      ...
      changelogMetaDescription: "DL-Merge-In release history and update details.", changelogKicker: "Release history", changelogTitle: "Change history", changelogLead: "Details for versions delivered through DL-Merge-In updates.", changelog123Title: "Version 1.2.3", changelog123Date: "Released September 6, 2026", changelog123Summary: "Adds signed in-app updates to the Windows desktop edition.", changelog123Body: "DL-Merge-In now checks for new formal releases and shows an Update button. You can update now, defer, or open the official change history. Updates download, verify, and apply changed files in the app while showing progress. The app guides Chrome or Edge extension reload when required and restores the previous files if an update fails. Run the v1.2.3 setup once when moving from version 1.1.0.", changelog122Title: "Version 1.2.2", changelog122Date: "Publication ended September 6, 2026", changelog122Summary: "Test-only version withdrawn after passing the coordinated Chrome and Edge update test.", changelog122Body: "There were no functional changes. The update from the corrected baseline version 1.2.0 was verified in both browsers, including data retention. This version will not be reused.", changelog121Title: "Version 1.2.1", changelog121Date: "Publication ended September 6, 2026", changelog121Summary: "Test-only version withdrawn after the first installation test was stopped.", changelog121Body: "The Release was deleted after a concurrent Chrome and Edge startup issue was found. This version will not be reused."
    },
    ja: {
      ...
      changelogMetaDescription: "DL-Merge-Inの公開バージョン履歴とアップデート内容です。", changelogKicker: "リリース履歴", changelogTitle: "変更履歴", changelogLead: "DL-Merge-Inのアップデートで配信する各バージョンの内容を掲載します。", changelog123Title: "バージョン 1.2.3", changelog123Date: "2026年9月6日公開", changelog123Summary: "Windowsデスクトップ版に、署名付きのアプリ内アップデート機能を追加しました。", changelog123Body: "新しい正式版を自動確認して「更新」ボタンを表示します。クリック後は「今すぐ更新」「後で更新」「変更内容」を選択でき、差分ファイルの取得・検証・適用と進捗表示をアプリ内で行います。必要な場合はChromeまたはEdgeの拡張機能を再読み込みする手順を案内し、更新途中の失敗時は旧ファイルへ復旧します。バージョン1.1.0から移行するときだけ、v1.2.3のセットアップを一度実行してください。", changelog122Title: "バージョン 1.2.2", changelog122Date: "2026年9月6日公開終了", changelog122Summary: "ChromeとEdgeの連動更新試験に合格し、公開を終了したテスト専用バージョンです。", changelog122Body: "機能上の変更はありません。同時起動修正版のバージョン1.2.0から更新し、両ブラウザーへの反映とデータ保持を確認しました。このバージョンは再利用しません。", changelog121Title: "バージョン 1.2.1", changelog121Date: "2026年9月6日公開終了", changelog121Summary: "第1回実機試験を中止し、公開を終了したテスト専用バージョンです。", changelog121Body: "ChromeとEdgeの同時起動問題を検出したため、Releaseを削除しました。このバージョンは再利用しません。"
    },
  ...
  Object.assign(copy.en, {
    ...
    ctaButton: "Windows desktop edition v1.2.3",
    ctaMeta: "Version 1.2.3 · Windows · Chrome supported · Edge available during setup",
    ctaHint: "This release is unsigned. Before downloading, verify the official URL, version, SHA-256, and important notices.",
    ...
    downloadMetaDescription: "Review the Windows desktop edition v1.2.3 installer, SHA-256, and unsigned-release notice before downloading DL-Merge-In.",
    ...
    downloadUpgradeNote: "Version 1.1.0 does not include in-app updates. Run this setup once to move to v1.2.3; supported releases after v1.2.3 can be installed from Update in the app.",
    ...
    unsignedBody1: "This release is not code-signed. Windows may therefore show a SmartScreen or unknown publisher warning.",
    unsignedBody2: "If a warning appears, verify the download source, file name, version, and SHA-256 before proceeding. If anything does not match or you are unsure, do not run the file. Recheck the <a href=\"https://github.com/dl-merge-in/DL-Merge-In/releases/tag/v1.2.3\">Release page</a> and this page.",
