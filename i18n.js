...
(() => {
  ...
  const copy = {
    en: {
      ...
      changelogMetaDescription: "DL-Merge-In release history and update details.", changelogKicker: "Release history", changelogTitle: "Change history", changelogLead: "Details for versions delivered through DL-Merge-In updates.", changelog121Title: "Version 1.2.1", changelog121Date: "Published September 6, 2026", changelog121Summary: "Temporary public release for the update installation test.", changelog121Body: "There are no functional changes. Only the version metadata differs from the test baseline version 1.2.0."
    },
    ja: {
      ...
      changelogMetaDescription: "DL-Merge-Inの公開バージョン履歴とアップデート内容です。", changelogKicker: "リリース履歴", changelogTitle: "変更履歴", changelogLead: "DL-Merge-Inのアップデートで配信する各バージョンの内容を掲載します。", changelog121Title: "バージョン 1.2.1", changelog121Date: "2026年9月6日公開", changelog121Summary: "アップデート機能の実機試験用に一時公開するバージョンです。", changelog121Body: "機能上の変更はありません。テスト元のバージョン1.2.0から、バージョン情報だけを変更しています。"
    },
