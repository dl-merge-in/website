...
(() => {
  ...
  const copy = {
    en: {
      ...
      changelogMetaDescription: "DL-Merge-In release history and update details.", changelogKicker: "Release history", changelogTitle: "Change history", changelogLead: "Details for versions delivered through DL-Merge-In updates.", changelog122Title: "Version 1.2.2", changelog122Date: "Publication ended September 6, 2026", changelog122Summary: "Test-only version withdrawn after passing the coordinated Chrome and Edge update test.", changelog122Body: "There were no functional changes. The update from the corrected baseline version 1.2.0 was verified in both browsers, including data retention. This version will not be reused.", changelog121Title: "Version 1.2.1", changelog121Date: "Publication ended September 6, 2026", changelog121Summary: "Test-only version withdrawn after the first installation test was stopped.", changelog121Body: "The Release was deleted after a concurrent Chrome and Edge startup issue was found. This version will not be reused."
    },
    ja: {
