...
├─ style.css           # サイトのスタイル
├─ script.js           # 小さな画面効果
├─ i18n.js             # 言語判定と英語・日本語の基本辞書
├─ translations.js     # そのほか9言語のサイト本文辞書
├─ guide-translations.js # そのほか9言語のセットアップガイド辞書
├─ assets/             # OGP画像、匿名化済み画面画像、案内動画
...
- トップページはアプリと同じ11言語に対応し、ブラウザの優先言語を使用します。ダウンロード、改訂履歴、セットアップガイド、法的情報、対応サービス、OSSライセンスなどトップ以外のページは日本語・英語のみとし、英日以外の指定は英語へフォールバックします。日本語LP内の表示ブランドに限り **DL名人** と表記します。
